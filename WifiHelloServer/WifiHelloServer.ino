...
#define _SSID "AmyChen"        // Your WiFi SSID
#define _PASSWORD "0982355465"    // Your WiFi Password
#define PROJECT_ID "beacon-backend"
   // Your Firebase Project ID. Can be found in project settings.
